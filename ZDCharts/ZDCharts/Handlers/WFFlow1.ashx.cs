        ...
        public Tools.JsonResponse GetListGroupByCompany()
        {
            ...
            using (DAL.ContractEntities db = new DAL.ContractEntities())
            {
                ...
                var fList = db.V_Expense
                    .Where(p => p.IsFinished == COMN.MyVars.No && p.RoleID == user.RoleID && p.CompanyID.StartsWith("0" + user.AccountBook) && (p.ApprovalStatus == COMN.MyVars.ApprovalStatus_IsHandling
