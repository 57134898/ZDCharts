...
namespace ZDCharts
{
    public partial class Temp : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            DataTable result = DBHelper.ExecuteDataTable(string.Format("INSERT INTO {0}.dbo.ccode (CCODE,CNAME) VALUES('1','1')", COMN.MyVars.CWDB));
            Response.Write(result.Rows.Count);
